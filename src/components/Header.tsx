...
const Header = () => {
  ...
  useEffect(() => {
    function onDoc(e: MouseEvent) {
      ...
      if (debitRef.current && !debitRef.current.contains(target))
        setOpenDebit(false);
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between px-10">
        {/* Title */}
        <div className="text-2xl font-semibold text-[#3386FF]">Dashboards</div>

        <div className="flex items-center gap-4">
          {/* Balance pill */}
          <button
            className="h-9 px-3 rounded-full bg-gray-100 font-semibold text-sm inline-flex items-center gap-2 border border-gray-200 hover:bg-gray-200/80"
            aria-label="Balance"
          >
            <span>₹ 25,000</span>
            ...
            {openAdd && (
              ...
              >
                <button
                  type="button"
                  onClick={() => {
                    router.push("/manage-balance/add-funds");
                    setOpenAdd(false);
                  }}
              ...
              >
                <div className="space-y-4">
                  <button
                    type="button"
                    onClick={() => {
                      router.push("/manage-balance/debit-funds?view=withdraw");
                      setOpenDebit(false);
                    }}
                  ...
                  <button
                    type="button"
                    onClick={() => {
                      router.push("/manage-balance/debit-funds?view=transfer");
                      setOpenDebit(false);
                    }}
